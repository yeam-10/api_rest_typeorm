...
exports.deleteuser = exports.createusers = exports.updateusers = exports.getusersi = exports.getusers = void 0;
...
//Consult users
exports.getusersi = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resultUsers;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                resultUsers = _a.sent();
                return [2 /*return*/, res.json(resultUsers)];
        }
    });
}); };
//Put users
exports.updateusers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var upuser, resultup;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(user_1.user).findOne(req.params.id)];
            case 1:
                upuser = _a.sent();
                if (!upuser) return [3 /*break*/, 3];
                typeorm_1.getRepository(user_1.user).merge(upuser, req.body);
                return [4 /*yield*/, typeorm_1.getRepository(user_1.user).save(upuser)];
            case 2:
                resultup = _a.sent();
                return [2 /*return*/, res.json(resultup)];
